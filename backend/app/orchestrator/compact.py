...
def _merge_summaries(
    ...
    merged = {}
    for key in ['purchase_item', 'purchase_date', 'purchase_amount', 'purchase_place',
    ...
    merged['compacted_turn_count'] = (
        existing_dict.get('compacted_turn_count', 0) +
...
def compact_conversation(
    ...
    logger.info(f"[Compact] Extracted: item={merged.get('purchase_item')}, "
